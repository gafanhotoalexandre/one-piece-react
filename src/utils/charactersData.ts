import characterTonyChopper from '../assets/images/personagem-tony-chopper.png'
import characterRoronoaZoro from '../assets/images/personagem-roronoa-zoro.png'
import characterMonkeyDLuffy from '../assets/images/personagem-monkey-d-luffy.png'
import characterNami from '../assets/images/personagem-nami.png'
import characterSanji from '../assets/images/personagem-sanji.png'

export const charactersData = [
  {
    name: 'Tony Tony Chopper',
    imageSrc: characterTonyChopper,
  ...
  {
    name: 'Monkey D. Luffy',
    imageSrc: characterMonkeyDLuffy,
