import personagemTonyChopper from '../assets/images/personagem-tony-chopper.png'
import personagemRoronoaZoro from '../assets/images/personagem-roronoa-zoro.png'
import personagemMonkeyDLuffy from '../assets/images/personagem-monkey-d-luffy.png'
import personagemNami from '../assets/images/personagem-nami.png'
import personagemSanji from '../assets/images/personagem-sanji.png'

export const charactersData = [
  {
    name: 'Tony Tony Chopper',
    imageSrc: personagemTonyChopper,
    alt: 'Imagem do Tony Tony Chopper',
    description:
  ...
  {
    name: 'Roronoa Zoro',
    imageSrc: personagemRoronoaZoro,
    alt: 'Imagem do Roronoa Zoro',
    description:
  ...
  {
    name: 'Monkey D. Luffy',
    imageSrc: personagemMonkeyDLuffy,
    alt: 'Imagem do Monkey D. Luffy',
    description:
  ...
  {
    name: 'Vinsmoke Sanji',
    imageSrc: personagemSanji,
    alt: 'Imagem do Vinsmoke Sanji',
    description:
